...
for r=1:round(round_count/2),
    ...
    if (r == 1)
        [ A_omp ] = learn_omp_bases(...
            patches, 2*basis_count, omp_count, omp_step, 1, omp_l1 );
    else
        [ A_omp ] = learn_omp_bases(...
            patches, 2*basis_count, omp_count, omp_step, 1, omp_l1, A_omp );
    end
end

% Save learned feature matrices and such
save('cifar_bases_500.mat');
